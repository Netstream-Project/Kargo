...
export default function SupplierListModal() {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 md:p-8">
      ...
      {/* Modal Container */}
      <div className="relative w-full max-w-5xl bg-white shadow-[0px_12px_32px_rgba(26,28,28,0.2)] flex flex-col max-h-[921px] overflow-hidden rounded-lg">
        ...
        <div className="flex items-center justify-between px-8 py-6 border-b border-slate-200 bg-white">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h2 className="text-2xl font-black tracking-tighter text-[#142026] leading-none">Container Manifest: KRG-44102</h2>
        ...
        <div className="px-8 py-6 bg-slate-50 border-t border-slate-200 flex justify-between items-center">
          ...
          <div className="flex gap-4">
            <button className="px-6 py-3 bg-white border border-slate-300 text-[#142026] font-bold text-sm hover:bg-slate-50 transition-all rounded-lg">
              Download PDF Manifest
            </button>
            <button className="px-8 py-3 bg-[#460003] text-white font-bold text-sm hover:brightness-110 active:scale-95 transition-all shadow-lg rounded-lg">
              Submit Audit Report
            </button>
          </div>
        </div>
